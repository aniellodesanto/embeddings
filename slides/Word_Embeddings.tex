...
\title{\texorpdfstring{Lexical Semantics and Word Embeddings}{}}
\author{Aniello De Santo}
\institute{San Jose State\\\texttt{aniello.desanto@stonybrook.edu}}
\date{}
...
\begin{itemize}
\item  A  two-layer NN trained to reconstruct linguistic contexts of words
